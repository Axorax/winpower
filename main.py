...
def create_window():
    ...
    def set_active_values():
        ...
        brightness_value = core.get_brightness() if core.get_brightness() is not None else 50
        brightness_slider.set(int(brightness_value))
        
        mouse_speed_value = core.get_mouse_speed() if core.get_mouse_speed() is not None else 10
